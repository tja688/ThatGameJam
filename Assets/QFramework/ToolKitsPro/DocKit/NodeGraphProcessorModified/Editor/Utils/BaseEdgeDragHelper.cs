...
namespace GraphProcessor
{
    public class BaseEdgeDragHelper : EdgeDragHelper
    {
        ...
        bool HandleDown(Vector2 mousePosition)
        {
        ...
        public override bool HandleMouseDown(MouseDownEvent evt) => HandleDown(evt.mousePosition);

#if UNITY_2021_2_OR_NEWER || UNITY_6000_0_OR_NEWER
        public override bool HandlePointerDown(PointerDownEvent evt) => HandleDown(evt.position);
#endif
        ...
        void HandleMove(Vector2 mousePosition, Vector2 localPosition, VisualElement target)
        {
            var ve = target;
            Vector2 gvMousePos = ve.ChangeCoordinatesTo(graphView.contentContainer, localPosition);
        ...
        public override void HandleMouseMove(MouseMoveEvent evt) =>
            HandleMove(evt.mousePosition, evt.localMousePosition, (VisualElement)evt.target);

#if UNITY_2021_2_OR_NEWER || UNITY_6000_0_OR_NEWER
        public override void HandlePointerMove(PointerMoveEvent evt) =>
            HandleMove(evt.position, evt.localPosition, (VisualElement)evt.target);
#endif
        ...
        public override void HandleMouseUp(MouseUpEvent evt) => HandleUp(evt.mousePosition);

#if UNITY_2021_2_OR_NEWER || UNITY_6000_0_OR_NEWER
        public override void HandlePointerUp(PointerUpEvent evt) => HandleUp(evt.position);
#endif
